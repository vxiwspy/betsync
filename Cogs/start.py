...
class Start(commands.Cog):
    ...
    class MainView(discord.ui.View):
        ...
        async def signup(self, ctx):
            embed = discord.Embed(title=":wave: **Welcom to BetSync Casino**", value="Press The Button Below To Sign Up If You're A New User!", color=0x00FFAE, icon_url=self.bot.user.avatar.url)
